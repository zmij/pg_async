...
class AAwmPlayerState : public APlayerState
{
	...
	void ScoreKill(AAwmPlayerState* Victim, int32 Points);
	...
	void InformAboutKill(class AAwmPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAwmPlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
	void BroadcastDeath(class AAwmPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAwmPlayerState* KilledPlayerState);
