...
AAwmExplosionEffect::AAwmExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AAwmExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AAwmExplosionEffect::Tick(float DeltaSeconds)
{
